...
class Model(object):
    ...
    def fit(self, data, init, method='BFGS', verbose=False, dispMsg=True):
        data_args = []
        shared_params = []
        ...
        logging.debug('Minimizing negative log-likelihood of model...')
        ...
        if method.upper() == 'MINUIT':
            ...
            results = minimize(func, method=method, jac=g_func, x0=x0, options={'disp': dispMsg})
